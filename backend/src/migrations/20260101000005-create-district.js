...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex('district', ['tenant_id'], { name: 'ix_district_tenant' });
    await queryInterface.addIndex('district', ['tenant_id', 'code'], { unique: true, name: 'uq_district_tenant_code' });
  },
